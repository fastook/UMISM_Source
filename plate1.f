...
c-----------------------------------------------------------------------
c 4th order plate solver with each-iteration generation of stiffness and
...
c iterative matrix solver. j fastook march 5, 1999
c-----------------------------------------------------------------------
...
1002  FORMAT(A,/,(1P2E13.6))
      END
C=============================================================
      SUBROUTINE PASSMB(N3,NZ,GK,GC,GF,KA,KZ,EK,EC,EF,N,NODE)
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION GK(N3,NZ),GC(N3,NZ),GF(N3)
...
C=============================================================
     ...
     &                  GK,GC,GF,KA,KZ,DELT)
      ...
      DIMENSION GK(N3,NZ),GF(N3),GC(N3,NZ)
      DIMENSION KA(N3,NZ+1),KZ(N3)
...
c          PAUSE
        ENDIF
C..................................
        CALL PASSMB(N3,NZ,GK,GC,GF,KA,KZ,EK,EC,EF,12,LLM)
C..................................
C        DO I=1,NNODE
