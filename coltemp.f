      SUBROUTINE COLTEMPT(TIME,IPT,NUMNP,AMASS,ADOT,TTTT,
...
C        PRINT *,' TTTT ',(REAL(TTTT(KKK)),KKK=1,NPT)
        CALL TRI(NPT,AAAL,AAAD,AAAU,FFFF,TTTT) 
C        PRINT *,' AFTER ',(REAL(TTTT(KKK)),KKK=1,NPT)
C        PAUSE
...
c     &           IPT
          ...
          CALL BACKSUB(NPT,AAAD,AAAU,FFFF,TTTT) 
        ENDIF
C
...
C         TTTT(I)=MIN(TTTT(I),PMPLOC)
        ENDDO
        IF(ISCAN.GT.0.AND.IOTOGG) 
     &    PRINT *,ISCAN,' POLYTHERMAL AT ',IPT
C ..................................................................
        AAAD(1)=RK11                                                    
        AAAU(1)=RK12                                                    
        AAAL(1)=RK21                                                    
...
c         BMELT=-(SIGMAL-SIGMABC)/RKX(NPT-1)
