...
C .......... FORMAT STATEMENTS ..............
C READ INPUT HEADER
c     READ(30,1000) HED,NUMNP,NUMEL,NUMCOL,NUMLEV,NUMGBC,NDT,INTER,DT
      READ(30,'(a)') HED
      READ(30,*) NUMNP,NUMEL,NUMCOL,NUMLEV,NUMGBC,NDT,INTER,DT
      PRINT *,HED
      write(*,*) NUMNP,NUMEL,NUMCOL,NUMLEV,NUMGBC,NDT,INTER,DT
